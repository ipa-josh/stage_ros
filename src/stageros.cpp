...
private:
    ...
    struct StageRobot
    {
        ...
        ros::Subscriber pose_sub; //allow changing position manually
    };
...
public:
	...
	// Message callback for Pose2D message to manually set the robots position
	void poseReceived(int r, const boost::shared_ptr<geometry_msgs::Pose2D const>& msg);
